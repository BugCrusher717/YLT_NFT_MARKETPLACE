...
export const lazyMintNft = (metadataURL, sport, cnft) =>{
    return {
        chain: "BSC",
        contractAddress: "0x8bec8C43fcaBB14DF033222Ea8A8D73C66C219fE",
