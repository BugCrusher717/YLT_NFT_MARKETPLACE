...
contract YLNFT is ERC721URIStorage, EIP712, Ownable, AccessControl, ReentrancyGuard {
    ...
    function setCategoryAmount(string memory _sport, string memory _cnft, uint256 _amount) public returns (bool) {
        categoryAmount[_sport][_cnft] = _amount;
        return true;
    }

    function deleteCategory(string memory _sport, string memory _cnft) public returns (bool) {
